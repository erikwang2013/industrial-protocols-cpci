...
CompactPCI 协议包 — 机架式 PCI，需 CPCI 接口桥接。Requires dedicated hardware, bridged to vendor SDK or gateway via kernel Bridge layer.
...
CompactPCI interface card (ADLINK, Kontron, Schroff)
...
- CompactPCI system controller or interface card
